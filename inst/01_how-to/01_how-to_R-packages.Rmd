...
Building an R package can be tedious and frustrating if you don't have the right tools. This document summarizes the key tools I have learned so far. While learning to develop an R package, I found the following resources extremely helpful. You may prefer to use these:
